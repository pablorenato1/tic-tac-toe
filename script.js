...
btn1.addEventListener('click', ()=>{ // Player Vs Computer
...
btn2.addEventListener('click', ()=>{ // Player vs Player
    boxContainer.classList.remove("hide")
...
// Buttons Funtion
function buttonsFunction() { // Click Event
    let el = checkEl(); // If the click ill result in X or O
        ...
        if(this.childNodes.length == 0) {
            ...
            if(computerChoice == true && (turnCount%2)==1) {
                machineChoice();
            }
        }
}
function machineChoice() {
    ...
    // Save next turn
    turnCount++;
    checkForWinner();// After 'computer' choice
}
